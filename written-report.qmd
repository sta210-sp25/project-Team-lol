...
tidy(airbnb_fit) |>
  kable(digits = 3, caption = "Model Without Interaction Term")
```
...
vif(airbnb_fit) |>
  ...
  kable(digits = 3, caption = "VIF Values for Model Without Interaction")
...
leverage_summary <- diagnostics |>
  count(`High Leverage`, name = "Number of Observations")

kable(leverage_summary, caption = "Count of Observations by Leverage")
```
