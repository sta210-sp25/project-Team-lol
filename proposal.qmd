...
ggplot(data = airbnb, aes(x = price)) +
  ...
  labs(title = "Distribution of Airbnb Prices in New York City", x = "Listing Price (USD)", y = "Count") 
...
ggplot(airbnb, aes(x = price)) +
  ...
  labs(title = "Closer Look at Distribution of Price (Removed Outliers)", x = "Listing Price (USD)", y = "Count") +
  xlim(0, 2500) 
```
